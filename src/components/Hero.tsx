          ...
          <div className="text-olive-800 space-y-8 text-center max-w-4xl">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-olive-600 leading-relaxed max-w-3xl mx-auto">
                Transforming enterprise data challenges into strategic advantages through secure,
                compliant, and high-performance data solutions. I help organizations unlock the full
                potential of their data while ensuring GDPR compliance, reducing processing time by
                30%, and maintaining 99% data accuracy across complex enterprise ecosystems.
              </p>
            </div>
